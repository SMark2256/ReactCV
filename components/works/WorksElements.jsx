...
export const WorkElements =  workListElements_HU.map((work) => {
      return (
        <div className="relative cursor-pointer inline-flex flex-col border-cyan-900 bg-cyan-900/30 hover:bg-teal-800/30 hover:border-teal-500/50 hover:shadow-teal-500/40 shadow-xl shadow-black-500/80 rounded-3xl mx-5 md:mx-5 w-96 md:w-80 h-56 mb-10">
