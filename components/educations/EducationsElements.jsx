...
const EducationElements = ({ education }) => {
      return (
                          <div className="relative cursor-pointer border-cyan-900 bg-cyan-900/30 hover:bg-teal-800/30 hover:border-teal-500/50 hover:shadow-teal-500/40 shadow-xl shadow-black-500/80 rounded-3xl w-96 h-52 mb-10">
                              <h1 className=" text-2xl justify-end font-bold bg-teal-500/30 w-full rounded-t-2xl md:mb-0 mb-3">{education.start} <strong>-</strong> {education.end}</h1>     
