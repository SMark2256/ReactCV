...
export const educationElements =  educationListElements_HU.map((education) => {
      return (
                          <div className="relative cursor-pointer inline-flex flex-col border-cyan-900 bg-cyan-900/30 hover:bg-teal-800/30 hover:border-teal-500/50 hover:shadow-teal-500/40 shadow-xl shadow-black-500/80 rounded-3xl align-middle mx-4 w-1/4 h-80 mb-10 items-center">
                                <h1 className=" text-3xl justify-end font-bold w-full rounded-t-2xl bg-blue-800/10">{education.start} <strong>-</strong> {education.end}</h1>     
