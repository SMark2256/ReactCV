...
const NavBarMode = ({ stylemode, onClick, open }) => {
    ...
    const mobileMode = "text-3xl text-center text-white w-5/6 font-semibold my-2 bg-cyan-500 shadow-lg shadow-cyan-500/30 hover:bg-teal-600 hover:shadow-teal-700 rounded-xl overflow-y-hidden"
