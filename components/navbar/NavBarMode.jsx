...
const NavBarMode = ({ stylemode, onClick, open }) => {
    ...
    const mobileMode = "text-xl text-center ml-1 text-white w-36 h-10 font-semibold my-2 bg-cyan-500 shadow-lg shadow-cyan-500/30 hover:bg-teal-600 hover:shadow-teal-700 rounded-xl overflow-y-hidden"
